...
public class ResponseService {
    ...
    private static String vprUrl = "http://36.7.144.236:8088";
    ...
    public static String auth(String username, String password) {
        ...
        String str = OkHttpRequest.sendPost(url, params);
        return str;
    }
    ...
    public static String registerUser(String username,String password) {
        String url = actionUrlV3 + "/user/register";
        HashMap params = new HashMap();
        params.put("clientId", Config.CLIENT_ID);
        params.put("clientSecret", Config.CLIENT_SECRET);
        params.put("username", username);
        params.put("password", DigitUtil.getMD5(password));
        params.put("date", String.valueOf(System.currentTimeMillis()));
        return OkHttpRequest.sendPost(url, params);
    ...
    public static String resetPassword(String username,String password) {
        String url = actionUrlV3 + "/user/resetPassword";
        HashMap params = new HashMap();
        params.put("clientId", Config.CLIENT_ID);
        params.put("clientSecret", Config.CLIENT_SECRET);
        params.put("username", username);
     ...
     * @return
     */
    public static String getUserList(Long startDate,Long endDate,Integer pageNo,Integer pageSize) {
        String url = actionUrlV3 + "/user/list";
    ...
    public static String deleteUser(String username) {
        String url = actionUrlV3 + "/user/delete";
        Map params = new HashMap();
        params.put("clientId",Config.CLIENT_ID);
        params.put("clientSecret",Config.CLIENT_SECRET);
        params.put("username",username);
     ...
     * @return
     */
    public static String getListKey(Integer lockId,Integer pageNo,Integer pageSize) {
     ...
     * @return
     */
    public static String deleteAllKey(Integer lockId) {
        String url = actionUrlV3 + "/lock/deleteAllKey";
        Map params = new HashMap();
        params.put("clientId",Config.CLIENT_ID);
        params.put("accessToken",MyPreference.getStr(MyApplication.mContext,MyPreference.ACCESS_TOKEN));
        params.put("lockId",String.valueOf(lockId));
    ...
    public static String deleteKey(Integer keyId) {
     ...
     * @throws IOException
     */
    public static String registerVoice(String groupId, List<File> pathList) throws IOException {
        String url = vprUrl + "/vpr/register";
        Map params = new HashMap();
        params.put("accessToken", MyPreference.getStr(MyApplication.mContext, MyPreference.ACCESS_TOKEN));
        params.put("groupId",groupId);

        return OkHttpRequest.sendFromDataPostRequest(url,pathList,params);
    }
     ...
     * @throws IOException
     */
    public static String verifyVoice(List<File> pathList) throws IOException {
        String url = vprUrl + "/vpr/verify";
        Map params = new HashMap();
     ...
     * @throws IOException
     */
    public static String verifyVoiceMany(String groupId,List<File> pathList) throws IOException {
        String url = vprUrl + "/vpr/recognize";
        Map params = new HashMap();
        params.put("groupId",groupId);
        params.put("accessToken", MyPreference.getStr(MyApplication.mContext, MyPreference.ACCESS_TOKEN));
        return OkHttpRequest.sendFromDataPostRequest(url,pathList,params);
     ...
     * @throws IOException
     */
    public static String verifyVoiceFormat(List<File> pathList) throws IOException {
        String url = vprUrl + "/vpr/testFile";
        Map params = new HashMap();
        params.put("accessToken", MyPreference.getStr(MyApplication.mContext, MyPreference.ACCESS_TOKEN));
        return OkHttpRequest.sendFromDataPostRequest(url,pathList,params);
    }
     ...
     * @throws IOException
     */
    public static String PcmDownload(String code) throws IOException {
        String url = vprUrl + "/vpr/download";
        Map params = new HashMap();
