...
//    private String accessToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_lockName = findViewById(R.id.tv_lockName);
...
//            startActivity(intent);
            ...
            Intent intent = new Intent(this,VoiceVerifyActivity.class);
            startActivity(intent);
        }
    }
...
//                    }
            ...
            protected void onPostExecute(String json) {
                ...
                try {
                    JSONObject jsonObject = new JSONObject(json);
                    String keyList = jsonObject.getString("keyList");
                    JSONArray jsonArray = new JSONArray(keyList);
                    JSONObject jsonObject1 = (JSONObject) jsonArray.get(0);
                    final String lockName = jsonObject1.getString("lockName");
                    ...
                    if(keys!=null && keys.size() > 0) {
                        curKey = keys.get(0);
                        Intent intent = new Intent(MainActivity.this,VoiceVerifyActivity.class);
                        startActivity(intent);
                    }
